...
export const DEFAULT_REPLIES: Record<string, Reply[]> = {
  "sticky": [
    ...
    { id: "rsp", author: "Anonymous", content: "OP no ha vuelto a postear. Llevamos 24 horas.\n\nAlguien conoce empresas de construccion en el norte que alquilen containers a particulares? Por curiosidad.", createdAt: "2026-02-19T11:00:00.000Z" },
    { id: "rsq", author: "nocturno_ls", content: ">>rsp\nHay varias en la zona industrial. Algunas grandes alquilan modulos como almacenaje extra para particulares. Cementeras, empresas de obra, ese tipo de cosas. No te puedo decir nombres porque no lo se.", createdAt: "2026-02-19T14:20:00.000Z" },
