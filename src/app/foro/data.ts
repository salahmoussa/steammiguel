...
export const DEFAULT_THREADS: Thread[] = [
  {
    id: "sticky",
    title: "SOY POLICIA INFILTRADO EN LOS MADRAZO. SI DESAPAREZCO, LEED ESTO.",
    author: "throwaway_8847",
    content: "Se que nadie me va a creer y me da igual. Llevo 14 meses infiltrado en la organizacion de los Madrazo como agente encubierto del LSPD. Mi nombre real no lo voy a decir pero mi placa es la 4471. Si alguien del departamento lee esto, sabra quien soy.\n\nMe metieron como conductor. Empiece llevando paquetes de Paleto a La Mesa, sin saber que habia dentro. A los 3 meses ya estaba en reuniones con gente seria. He visto cosas que no puedo contar aqui pero tengo TODO documentado: nombres, fechas, rutas, contactos dentro del ayuntamiento y del propio departamento de policia.\n\nHace 2 semanas mi handler dejo de contestar al telefono. He ido 3 veces al punto de contacto y no ha aparecido nadie. He llamado a asuntos internos y me han dicho que \"no consta ninguna operacion activa con esa descripcion\".\n\nMe han dejado tirado. O peor, alguien de dentro ha filtrado mi posicion.\n\nAyer encontre un GPS tracker debajo de mi coche. No era de los nuestros.\n\nSi dejo de postear, ya sabeis lo que ha pasado. La documentacion esta en una caja fuerte en una taquilla del Vespucci Movie Masks, taquilla 117. La combinacion es el numero de mi placa al reves.\n\nNo se cuanto tiempo me queda.",
    replies: 20,
...
export const DEFAULT_REPLIES: Record<string, Reply[]> = {
  "sticky": [
    { id: "rsa", author: "Anonymous", content: ">soy policia infiltrado\n>posteo en 5chan a las 3am\n\nsi claro y yo soy el alcalde de Los Santos. Vete a dormir.", createdAt: "2026-02-18T03:25:00.000Z" },
    ...
    { id: "rsd", author: "throwaway_8847", content: ">>rsc\nPorque los Madrazo tienen contactos en Weazel News. Un editor de la seccion de sucesos esta en nomina. No puedo confiar en nadie fuera de aqui. Al menos esto es anonimo.", createdAt: "2026-02-18T03:47:00.000Z" },
    { id: "rse", author: "Anonymous", content: "Placa 4471... alguien puede verificar si eso es real? Alguno que trabaje en el LSPD?", createdAt: "2026-02-18T04:05:00.000Z" },
    { id: "rsf", author: "carlos_rp94", content: "Esto es un LARP de manual. Todos los meses sale uno de estos. La semana pasada uno decia que era piloto de Merryweather y que habia visto ovnis en Chiliad.", createdAt: "2026-02-18T06:30:00.000Z" },
    { id: "rsg", author: "Anonymous", content: "Lo del GPS tracker es un detalle muy especifico para ser inventado. Y lo de que el handler no conteste... eso pasa mas de lo que la gente cree. Conozco casos.", createdAt: "2026-02-18T08:15:00.000Z" },
    { id: "rsh", author: "throwaway_8847", content: "Actualizacion: esta manana habia un Cavalcade negro aparcado en mi calle que no es de ningun vecino. Lleva ahi desde las 6am. No se ha movido. Tiene los cristales tintados.\n\nHe cambiado la documentacion a una segunda ubicacion por si acaso. La taquilla 117 sigue siendo valida como punto de partida.", createdAt: "2026-02-18T10:22:00.000Z" },
    ...
    { id: "rsj", author: "Anonymous", content: ">contactos dentro del ayuntamiento y del propio departamento de policia\n\nsi esto es real acabas de firmar tu sentencia de muerte publicandolo aqui, lo sabes no? Da igual que sea anonimo. Si ellos leen esto van a saber exactamente quien eres.", createdAt: "2026-02-18T11:30:00.000Z" },
    { id: "rsk", author: "throwaway_8847", content: ">>rsj\nYa lo se. Por eso lo publico. Si me pasa algo quiero que la gente sepa que no fue un accidente ni un suicidio. Soy un poli que hizo su trabajo y su propio departamento lo abandono.\n\nSi veis en Weazel News que un agente \"fallecio en acto de servicio\" o \"tuvo un accidente de trafico\", ya sabeis la verdad.", createdAt: "2026-02-18T11:45:00.000Z" },
    ...
    { id: "rsn", author: "Anonymous", content: "Acabo de buscar en las noticias de Weazel. Ayer por la noche encontraron el cuerpo de un hombre de 34 anos con un disparo en la cabeza en un callejon de La Mesa. \"La policia investiga las circunstancias del fallecimiento.\" No dan nombre.\n\nNo estoy diciendo que sea OP. Pero el timing...", createdAt: "2026-02-19T09:30:00.000Z" },
    ...
    { id: "rsp", author: "Anonymous", content: "OP no ha vuelto a postear. Llevamos 24 horas.\n\nAlguien ha ido a la taquilla 117 del Vespucci Movie Masks?", createdAt: "2026-02-19T11:00:00.000Z" },
    { id: "rsq", author: "nocturno_ls", content: "He pasado por el Vespucci Movie Masks esta manana. La taquilla 117 existe pero necesitas la combinacion para abrirla. 1744 (4471 al reves). No me he atrevido a abrirla.\n\nSi alguien tiene mas huevos que yo, adelante.", createdAt: "2026-02-19T14:20:00.000Z" },
    ...
    { id: "rss", author: "Anonymous", content: "Weazel News acaba de confirmar: \"Agente del LSPD hallado muerto en La Mesa. Fuentes del departamento confirman que se encontraba en excedencia voluntaria.\" Excedencia voluntaria mis cojones. Era un infiltrado y lo mataron.\n\nRIP throwaway_8847. Tenias razon en todo.", createdAt: "2026-02-20T08:15:00.000Z" },
    { id: "rst", author: "tommy_flats", content: "Descansa en paz hermano. Hiciste lo correcto y te fallaron los tuyos.\n\nAlguien tiene que abrir esa puta taquilla.", createdAt: "2026-02-20T09:00:00.000Z" },
  ],
  "1": [
