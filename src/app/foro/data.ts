...
export const DEFAULT_THREADS: Thread[] = [
  {
    ...
    content: "No voy a decir quien soy ni donde trabajo. Solo necesito que esto quede por escrito en algun sitio.\n\nLlevo meses metido en algo que se me ha ido de las manos. Empece sin saber lo que estaba haciendo y cuando me di cuenta ya era tarde para salirme. He visto cosas que no se pueden olvidar. Gente que ha desaparecido. Dinero que no deberia existir.\n\nLas personas con las que estoy creen que soy uno mas. No lo soy. Pero si me descubren, no llegare a manana.\n\nHace dos semanas la persona con la que mantenia contacto dejo de responder. He ido tres veces al punto donde quedabamos y no ha aparecido nadie. Cuando he intentado avisar por los canales oficiales, me han dicho que no existe ningun registro. Como si nunca hubiera pasado.\n\nMe han dejado tirado. O peor, alguien me ha vendido.\n\nHace ocho dias encontre algo debajo de mi coche que no deberia estar ahi. Saben donde vivo. Saben en que coche me muevo. Es cuestion de dias.\n\nHe alquilado un container a una empresa en el norte, no me acuerdo muy bien cual era, pero se dedicaban a la construccion o algo por el estilo. Pague cuatro meses por adelantado en efectivo. En uno de esos containers tengo varias cosas guardadas.\n\nSi dejo de postear ya sabeis lo que ha pasado. No me busqueis. No preguntéis. Solo recordad que esto era real.",
    replies: 20,
    createdAt: "2025-06-08T03:12:00.000Z",
    sticky: true,
  },
  {
    id: "1",
...
export const DEFAULT_REPLIES: Record<string, Reply[]> = {
  "sticky": [
    { id: "rsa", author: "Anonymous", content: ">postea a las 3am\n>no da nombres\n>no da pruebas\n\nlarp del mes confirmado", createdAt: "2025-06-08T03:25:00.000Z" },
    { id: "rsb", author: "throwaway_8847", content: ">>rsa\nMe da igual que no me creas. Esto no es para ti. Es para que quede constancia por si me pasa algo.", createdAt: "2025-06-08T03:31:00.000Z" },
    { id: "rsc", author: "nocturno_ls", content: "Tio si esto es verdad por que coño lo publicas AQUI y no vas a un periodista o algo? Weazel News, lo que sea.", createdAt: "2025-06-08T03:40:00.000Z" },
    { id: "rsd", author: "throwaway_8847", content: ">>rsc\nPorque la gente con la que estoy tiene contactos en todas partes. Periodicos, ayuntamiento, la propia policia. No puedo confiar en nadie. Al menos esto es anonimo.", createdAt: "2025-06-08T03:47:00.000Z" },
    { id: "rse", author: "Anonymous", content: "Si es verdad, da algun detalle que se pueda verificar. Una matricula, un sitio, lo que sea. Sino esto no vale nada.", createdAt: "2025-06-08T04:05:00.000Z" },
    { id: "rsf", author: "carlos_rp94", content: "Larp de manual. Todos los meses sale uno de estos. La semana pasada uno decia que era piloto de Merryweather y que habia visto ovnis en Chiliad.", createdAt: "2025-06-08T06:30:00.000Z" },
    { id: "rsg", author: "Anonymous", content: "Lo del aparato debajo del coche es un detalle muy especifico para ser inventado. Y lo del contacto que no responde... eso pasa mas de lo que la gente cree. Conozco casos.", createdAt: "2025-06-08T08:15:00.000Z" },
    { id: "rsh", author: "throwaway_8847", content: "Actualizacion: esta manana habia un Cavalcade negro aparcado en mi calle que no es de ningun vecino. Lleva ahi desde las 6am. No se ha movido. Tiene los cristales tintados.\n\nNo voy a postear mucho mas. Solo queria que esto quedara escrito.", createdAt: "2025-06-08T10:22:00.000Z" },
    { id: "rsi", author: "tommy_flats", content: "Tio si de verdad hay un Cavalcade vigilandote SAL DE TU CASA. Vete a un motel, paga en efectivo, no uses el movil. Esto es sentido comun.", createdAt: "2025-06-08T10:40:00.000Z" },
    { id: "rsj", author: "Anonymous", content: "Si esto es real acabas de firmar tu sentencia de muerte publicandolo aqui, lo sabes no? Da igual que sea anonimo. Si ellos leen esto van a saber exactamente quien eres.", createdAt: "2025-06-08T11:30:00.000Z" },
    { id: "rsk", author: "throwaway_8847", content: ">>rsj\nYa lo se. Por eso lo publico. Si me pasa algo quiero que alguien sepa que no fue un accidente ni un suicidio.\n\nSi escuchais cualquier noticia rara estos dias, ya sabeis la verdad.", createdAt: "2025-06-08T11:45:00.000Z" },
    { id: "rsl", author: "paleto_boy", content: "Madre mia este hilo. No se si es real o no pero me estoy cagando encima leyendolo.", createdAt: "2025-06-08T13:00:00.000Z" },
    { id: "rsm", author: "Anonymous", content: "Han pasado 8 horas desde el ultimo post de OP. Alguien sabe algo?", createdAt: "2025-06-08T20:00:00.000Z" },
    { id: "rsn", author: "Anonymous", content: "Acabo de buscar en las noticias de Weazel. Ayer por la noche encontraron el cuerpo de un hombre con un disparo en la cabeza en un callejon de La Mesa. \"La policia investiga las circunstancias del fallecimiento.\" No dan nombre.\n\nNo estoy diciendo que sea OP. Pero el timing...", createdAt: "2025-06-09T09:30:00.000Z" },
    { id: "rso", author: "carlos_rp94", content: ">>rsn\nJoder. Joder joder joder. Puede ser coincidencia... verdad?", createdAt: "2025-06-09T09:45:00.000Z" },
    { id: "rsp", author: "Anonymous", content: "OP no ha vuelto a postear. Llevamos 24 horas.\n\nAlguien conoce empresas de construccion en el norte que alquilen containers a particulares? Por curiosidad.", createdAt: "2025-06-09T11:00:00.000Z" },
    { id: "rsq", author: "nocturno_ls", content: ">>rsp\nHay varias en la zona industrial. Algunas grandes alquilan modulos como almacenaje extra para particulares. Cementeras, empresas de obra, ese tipo de cosas. No te puedo decir nombres porque no lo se.", createdAt: "2025-06-09T14:20:00.000Z" },
    { id: "rsr", author: "Anonymous", content: "Este hilo deberia ser sticky permanente. Tanto si es real como si no, es lo mas heavy que se ha publicado en 5chan.", createdAt: "2025-06-09T16:00:00.000Z" },
    { id: "rss", author: "Anonymous", content: "Weazel News acaba de publicar una nota corta: \"Hombre encontrado fallecido en La Mesa. Identidad pendiente de confirmacion.\" Sin nombre, sin fotos, sin detalles. Raro.\n\nRIP throwaway_8847. Quien quiera que fueras.", createdAt: "2025-06-10T08:15:00.000Z" },
    { id: "rst", author: "tommy_flats", content: "Descansa en paz hermano. Esperemos que lo que dejaste aparezca algun dia.", createdAt: "2025-06-10T09:00:00.000Z" },
  ],
  "1": [
